<template>
  ...
  >
    <el-form :model="formData" :rules="rules" ref="formRef" label-width="120px">
      ...
      accept="image/*"
    >
      <div v-if="!imgUrl" class="cover-placeholder"><p>点击上传封面图片</p></div>
...
<el-button @click="handleClose">取消</el-button>
      <el-button @click="handleSumit" :loading="loading">{{ isEdit ? '更新文章' : '新增文章' }}</el-button>
    </template>
  </el-dialog>
</template>

<script setup>
import { ref, reactive, computed ,nextTick,watch} from "vue";  //watch对数据进行监听
